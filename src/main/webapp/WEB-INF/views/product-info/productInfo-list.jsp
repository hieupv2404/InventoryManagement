					...
					<div class="container" style="padding: 50px;">
						...
						<form:form modelAttribute="searchForm" cssClass="form-horizontal form-label-left" servletRelativeAction="/product-info/list/1" method="POST">
							...
							<div class="form-group">
								...
								<%--@declare id="cateName"--%>
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="category.name">Category </label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<form:input path="category.name" cssClass="form-control col-md-7 col-xs-12" />
								</div>
							</div>
