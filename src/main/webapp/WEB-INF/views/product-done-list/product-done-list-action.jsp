			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<form:form modelAttribute="modelForm" cssClass="form-horizontal form-label-left" servletRelativeAction="/product-done-list/save" method="POST">
							<form:hidden path="id" />
...
<script type="text/javascript">
	$(document).ready(
			function() {
				$('#productdonelistId').addClass('current-page').siblings()
						.removeClass('current-page');
				var parent = $('#productdonelistId').parents('li');
				parent.addClass('active').siblings().removeClass('active');
				$('#productdonelistId').parents().show();
			});
	function cancel() {
