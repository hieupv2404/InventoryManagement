			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<%--@elvariable id="modelForm" type="inventory"--%>
						<form:form modelAttribute="modelForm" cssClass="form-horizontal form-label-left" servletRelativeAction="/shelfoop/save" method="POST">
							<form:hidden path="id" />
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<form:input path="total" cssClass="form-control col-md-7 col-xs-12" disabled="${viewOnly}" />
									<div class="has-error">
										<form:errors path="total" cssClass="help-block"></form:errors>
									</div>
								</div>
							</div>
...
<script type="text/javascript">
	...
	function cancel() {
		window.location.href = '<c:url value="/shelfoop/list/"/>'
	}
</script>