			...
			<div class="x_panel">
				...
				<div class="x_content">
					...
					<div class="container" style="padding: 50px;">
						<%--@elvariable id="searchForm" type="inventory.controller.CategoryController"--%>
						<form:form modelAttribute="searchForm" cssClass="form-horizontal form-label-left" servletRelativeAction="/category/list/1" method="POST">
							...
							<div class="form-group">
								<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
									...
									<button class="btn btn-success"><a href="<c:url value="/category/getAll/1"/>"  style="color: white">Get All</a></button>
								</div>
							</div>
