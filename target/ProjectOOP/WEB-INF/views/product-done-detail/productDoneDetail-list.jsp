...
<div class="right_col" role="main">
	<div class="">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				<div class="x_title">
					<h2>Product Done Detail List</h2>
...
<%--							</div>--%>
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="productStatusList.code">Product Done List </label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<form:input path="productStatusList.code" cssClass="form-control col-md-7 col-xs-12" />
								</div>
							</div>
							<div class="form-group">
						...
						<table class="table table-striped jambo_table bulk_action">
							...
							<tbody>
								<c:forEach items="${products}" var="product" varStatus="loop">
									...
									<td class=" ">${product.productStatusList.code }</td>
...
<script type="text/javascript">
	 function confirmDelete(id){
		 if(confirm('Do you want delete this record?')){
			 window.location.href = '<c:url value="/product-done-detail/delete/"/>'+id;
		 }
	 }
	 function gotoPage(page){
		 $('#searchForm').attr('action','<c:url value="/product-done-detail/list/"/>'+page);
		 $('#searchForm').submit();
	 }
